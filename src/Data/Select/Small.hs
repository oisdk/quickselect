...
select3 _ _ _ _ _ = errorWithoutStackTrace "Data.Select.Small.select3: index out of bounds."
...
select4 _ _ _ _ _ _ = errorWithoutStackTrace "Data.Select.Small.select4: index out of bounds"
...
select5 _ _ _ _ _ _ _ = errorWithoutStackTrace "Data.Select.Small.select5: index out of bounds"
